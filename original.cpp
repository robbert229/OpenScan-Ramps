...
#define address I2C
    ...
    while (1)
    {
        while (menu != 0)
        {
            ...
            if (menu == 22 || menu == 23)
            { ///////////////////////////////////////////////// 2.2 Load Program OR 2.3. Mod Program
                cursor = 1;
                val = 1;
                while (val != 0)
                {
            ...
            { ///////////////////////////////////////////////// 35 - Choose Camera shutter mode
                ...
                while (digitalRead(buttonOK) == HIGH)
                {
                    if (digitalRead(buttonUP) == LOW && val < 8)
                    {
                        val = val + 1;
                    }
                    if (digitalRead(buttonDOWN) == LOW && val > 0)
                    {
                        val = val - 1;
                    }
